...
//    private readonly ICategoryService<Category, ICategory> _categoryService = new CategoryService(@"C:\Petra\Nackademin\Programmering-sharp\ShoppingProject\categories.json");
//    private readonly IProductService<Product, IProduct> _productService = new ProductService(@"C:\Petra\Nackademin\Programmering-sharp\ShoppingProject\products.json");
